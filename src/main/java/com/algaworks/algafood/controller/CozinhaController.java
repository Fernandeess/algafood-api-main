...
public class CozinhaController {
	...
	public ResponseEntity<Cozinha> Adicionar(@RequestBody Cozinha cozinhaBody) {
		Cozinha cozinha = cozinhaRepository.salvar(cozinhaBody);
	...
	public ResponseEntity<Cozinha> atualizar(@PathVariable Long id, @RequestBody Cozinha cozinhaBody) {
		...
		BeanUtils.copyProperties(cozinhaBody, cozinhaEntity,"id"); //Copiar propriedades de umas instancia para a  outra, terceiro parametro serve para definir o valor que sera ignorado

		cozinhaEntity = cozinhaRepository.salvar(cozinhaEntity);
